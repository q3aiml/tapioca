    ...
    describe("#cli::gem") do
      ...
      describe("generate") do
        ...
        it "must do mixin attribution properly" do
            ...
            write("lib/some_engine.rb", <<~RUBY)
              module SomeEngine
                class SomeController < ActionController::Base
                  # This method triggers a dynamic mixin
                  # which should be attributed to this gem and not
                  # actionpack, even though the real `include` happens
                  # inside actionpack
                  helper_method :foo
                end
              end
          ...
          out, _, status = @project.tapioca("gem actionpack typed_parameters some_engine")

          assert_includes(out, "Compiled actionpack")
          assert_includes(out, "Compiled typed_parameters")
          assert_includes(out, "Compiled some_engine")
          ...
          assert_project_file_equal("sorbet/rbi/gems/some_engine@0.0.2.rbi", <<~RBI)
            # typed: true
